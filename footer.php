            ...
            <div class="site-footer__col site-footer__brand">
                ...
                <div class="site-footer__social" aria-label="<?php esc_attr_e( 'Social links', 'rolling-reno' ); ?>">
                    ...
                    <?php if ( ! get_theme_mod( 'rr_social_instagram' ) ) : ?>
                        <a href="https://instagram.com/maracollins" class="site-footer__social-icon" rel="noopener noreferrer" target="_blank" aria-label="<?php esc_attr_e( 'Follow Mara on Instagram', 'rolling-reno' ); ?>">📷</a>
                        <a href="https://pinterest.com/maracollins" class="site-footer__social-icon" rel="noopener noreferrer" target="_blank" aria-label="<?php esc_attr_e( 'Follow Mara on Pinterest', 'rolling-reno' ); ?>">📌</a>
                    <?php endif; ?>
                </div>
            </div>
